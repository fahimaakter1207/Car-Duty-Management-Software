<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="AddProductCategory.aspx.cs" Inherits="AddProductCategory" %>
                                ...
                                <div class="panel-body">
                                    <div class="cmxform form-horizontal">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-lg-6">
                                                <asp:TextBox  ID="txtCategoryName" class=" form-control"   runat="server" required="required" placeholder="Enter company name......."></asp:TextBox>
                                            </div>
                                        </div>                                        
                                        <div class="form-group ">
                                            <label for="firstname" class="control-label col-lg-3">Opening Quantity :</label>
                                            <div class="col-lg-6">
                                                <asp:TextBox  ID="txtopqty" class=" form-control"   runat="server" required="required" placeholder="Enter company name......."></asp:TextBox>
                                            </div>
                                        </div>  
                                        <div class="form-group ">
                                            <label for="firstname" class="control-label col-lg-3">Remarks :</label>
                                            <div class="col-lg-6">
                                                <asp:TextBox  ID="txtRemarks" class=" form-control"   runat="server"  placeholder="Enter company name......."></asp:TextBox>
                                            </div>
                                        </div>  
                                        <div class="form-group">
