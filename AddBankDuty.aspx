<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="AddBankDuty.aspx.cs" Inherits="AddBankDuty" %>
                            ...
                            <div class="form-horizontal">
                             ...
                             <%--========================================================================--%>
                                ...
                                <div class="form-group" visibility: hidden >
                                    <label for="username form-field-1-1" class="col-sm-3 control-label no-padding-right">Actual Pick Time :</label>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtPickTime" class=" form-control" runat="server" TextMode="Time"   placeholder=" "></asp:TextBox>
                                    </div>
                                </div>
                                 <div class="form-group " visibility: hidden >
                                    <label for="username"   class="control-label col-lg-3 no-padding-right">Route : </label>
                                    <div class="col-lg-6">
                                        <asp:DropDownList ID="cmbRoute" class="form-control m-bot15 chosen-search "  runat="server"  EnableFilterSearch="true"  FilterType="StartsWith" EnableServerFiltering="true"  >
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <%--  <div class="form-group ">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-6">
                                        <asp:DropDownList ID="cmbBankDept" class="chosen-select form-control chosen-search " runat="server"  >
                                            <asp:ListItem Selected="True" Value="-1" Text="Select Bank Department Name"></asp:ListItem>
