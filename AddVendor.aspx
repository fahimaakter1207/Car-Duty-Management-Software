<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="AddVendor.aspx.cs" Inherits="AddVendor" %>
                ...
                <div class="panel-body">
                    <div class="cmxform form-horizontal">
                        ...
                        <div class="form-group ">
                            <label for="firstname" class="control-label col-lg-3">Vendor Name :</label>
                            <div class="col-lg-6">
