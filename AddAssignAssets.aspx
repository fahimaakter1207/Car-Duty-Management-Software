<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="AddAssignAssets.aspx.cs" Inherits="AddAssignAssets" %>
                                ...
                                <div class="panel-body">
                                    <div class="cmxform form-horizontal">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-lg-6">
                                                <asp:TextBox  ID="txtDeliveryDate" class=" form-control" type="date"  runat="server" required="required" placeholder="Enter company name......."></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group ">
