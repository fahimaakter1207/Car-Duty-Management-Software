<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="AddDepartment.aspx.cs" Inherits="AddDepartment" %>
                                ...
                                <div class="panel-body">
                                    <div class="cmxform form-horizontal">
                                        ...
                                        <div class="form-group ">
                                            <label for="firstname" class="control-label col-lg-3">Department Name :</label>
                                            <div class="col-lg-6">
                                                <asp:TextBox  ID="txtDepartmentName" class=" form-control"   runat="server" required="required" placeholder="Enter company name......."></asp:TextBox>
                                            </div>
                                        </div> 
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <asp:DropDownList ID="cmbcompany" class="form-control m-bot15" runat="server"></asp:DropDownList></td>
