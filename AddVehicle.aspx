<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="AddVehicle.aspx.cs" Inherits="AddVehicle" %>
                ...
                <div class="panel-body">
                    <div class="cmxform form-horizontal">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-6">
                                <asp:TextBox ID="txtVehicleName" class=" form-control" runat="server"   placeholder="Enter Vehicle Name"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group ">
                            <label for="lastname" class="control-label col-lg-3">Remarks :</label>
                            <div class="col-lg-6">
                                <asp:TextBox class=" form-control" ID="txtRemarks" runat="server" TextMode="MultiLine"  ></asp:TextBox>
                            </div>
                        </div>
