<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AddDutyRate_Admin.aspx.cs" Inherits="AddDutyRate_Admin" %>
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="username form-field-1-1" class="col-sm-3 control-label no-padding-right">Pickup Location :</label>

                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtPkLocation" class=" form-control" runat="server"   placeholder="Enter Pickup Location"></asp:TextBox>

                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Drop Off Location : </label>
