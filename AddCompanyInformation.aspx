<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="AddCompanyInformation.aspx.cs" Inherits="AddCompanyInformation" %>
                                ...
                                <div class="panel-body">
                                    <div class="cmxform form-horizontal">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-lg-6">
                                                <asp:TextBox  ID="txtCompanyName" class=" form-control"   runat="server" required="required" placeholder="Enter company name......."></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <label for="username" class="control-label col-lg-3">Website :</label>
                                            <div class="col-lg-6">
